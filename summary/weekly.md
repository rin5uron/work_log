...
### 💭 振り返り（途中メモ）
- **達成できたこと**: 実機テストで不具合を洗い出し、Reactの基本操作を整理
- **学んだこと**: エラーの切り分け手順（再現条件→原因仮説→検証）の重要性
- **難しかったこと**: 実機とブラウザで挙動が異なる箇所の検証
- **来週への課題**: サンプル共有まで仕上げ、DB/SQLの整理メモをまとめる
