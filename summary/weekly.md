...
- 基本情報勉強
    - 単語帳制作とマニュアル土台完成（3時間）
    - 基本情報対策：毎朝アプリ、夜は一章ずつ参考書（5時間）
- 毎日1時間はパソコンに向かいたいこと
    - Next.js・脱マウス毎日30分以内（3時間）
    - 案件見積もりMTと実装開始（5時間）
- 一旦保留
　- IT用語辞典整える（単語帳自動化土台とニコの見通しが持てたら！）
　- github actions（とりあえずissueとprojctの活用から始めよう）
<br><br><br>
---
...
| 日付    | 合計時間 | 主な学習内容 |
|---------|----------|--------------|
| 8/29(金) | 4h00m | 単語帳フォーマット/データ見直し、脱マウス、Next.js講座、ログ更新 |
