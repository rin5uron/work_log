...
| 日付    | 合計時間 | 主な学習内容 |
|---------|----------|--------------|
| 7/28(月) | 2h00m    | サブドメイン紐付け・ページ作り、SEOページ更新、オブジェクト演習ページ・脱マウス3日目、サイトセキュリティ対策 |
| 7/27(日) | 7h00m    | practiceREADME・オブジェクト演習ページ、脱マウス初心者ページ・脱マウスday2エラー対応、ニコデモページ・提案書作成 |
| 7/26(土) | 7h00m    | オブジェクト学習、週間サマリー・ワークログ作成、APIページ作成、毎日JS・基本情報CPU学習、CLIについておしゃべり、CPUについておしゃべり、モニター接続・脱マウス設定 |
| 合計    | 18h00m   |              |
